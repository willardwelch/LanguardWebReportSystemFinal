<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addEmployee.aspx.cs" Inherits="ReportSystem.addEmployee" MasterPageFile="Master.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                  ...
                  <tr>
                      <td>
                           <nav class="navbar navbar-expand-lg bg-red navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
                                  ...
                                  <h4 class="heading" >Add Employee</h4>
                            </nav>
    ...
    <table border="1" celspacing="2" cellpadding="2" bordercolor="blue">
        ...
        <tr>
         ...
         <tr>
             ...
             <td>
                 <asp:TextBox ID="dob" runat="server" Width="250px" MaxLength="18" TextMode="Date"> </asp:TextBox><asp:Label ID="Label2" runat="server" Text="(mm/dd/yyyy)"></asp:Label>
         ...
         <tr>
             ...
             <td>
                 <asp:TextBox ID="doe" Width="250px" runat="server" MaxLength="15" TextMode="Date"></asp:Textbox>
    ...
    <td>
        <asp:TextBox ID="txtRod" Width="250px" runat="server" MaxLength="15" TextMode="Date"></asp:Textbox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtRod" ErrorMessage="run out date is missing" Font-Size="Small" ForeColor="#CC0000"></asp:RequiredFieldValidator>
         ...
         <tr>
             ...
             <td>
                 <asp:TextBox ID="txtEndDate" Width="250px" runat="server" MaxLength="15" TextMode="Date"></asp:Textbox>
                 <asp:Label ID="Label5" runat="server" Text="mm/dd/yyyy)"></asp:Label>
              </td>
         </tr>
          <tr>
              <td align="right"></td> 
              <td align="left"><asp:Button Class="buttonclass" ID="Button1" runat="server" width="65px" Text="Save" OnClick="Button1_Click" />
