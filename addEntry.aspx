<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addEntry.aspx.cs" Inherits="ReportSystem.addEntry" MasterPageFile="~/Master.Master" %>
    ...
    <table width="550px" class="tableclass">
        <tr>
            ...
            <td class="auto-style1">
                <asp:TextBox ID="empNo" runat="server" Width="60px" AutoPostBack="True" OnTextChanged="empNo_TextChanged"></asp:TextBox>
    ...
    <td align="right"> Rank
        ...
        <tr>
         ...
         <tr>
             ...
             <td class="auto-style1">
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtOrderDate" ErrorMessage="*" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td align="left" class="auto-style1">
                <asp:Button ID="Save" Class="buttonclass" runat="server" Text="Save" OnClick="Save_Click" /></td>
        </tr>
